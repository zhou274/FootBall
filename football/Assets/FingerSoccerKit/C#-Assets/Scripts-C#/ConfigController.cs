...
public class ConfigController : MonoBehaviour {
	...
	void Awake (){
		...
		p1FormationLabel.GetComponent<TextMeshPro>().text = availableFormations[p1FormationCounter];	//loads default formation
		...
		p2FormationLabel.GetComponent<TextMeshPro>().text = availableFormations[p2FormationCounter];	//loads default formation
		...
		gameTimeLabel.GetComponent<TextMeshPro>().text = availableTimes[timeCounter];				//loads default game-time
	}
		...
		if (Physics.Raycast(ray, out hitInfo)) {
			...
			switch(objectHit.name) {
				...
				case "p1-FBL":
					...
					fixCounterLengths();		//when reached to the last option, start from the first index of the other side.
					p1FormationLabel.GetComponent<TextMeshPro>().text = availableFormations[p1FormationCounter]; //set the string on the UI
					break;
				...
				case "p1-FBR":
					...
					p1FormationCounter++;
					fixCounterLengths();
					p1FormationLabel.GetComponent<TextMeshPro>().text = availableFormations[p1FormationCounter];
					break;
				...
				case "p2-FBL":
					...
					p2FormationCounter--;
					fixCounterLengths();
					p2FormationLabel.GetComponent<TextMeshPro>().text = availableFormations[p2FormationCounter];
					break;
				...
				case "durationBtnLeft":
					...
					timeCounter--;
					fixCounterLengths();
					gameTimeLabel.GetComponent<TextMeshPro>().text = availableTimes[timeCounter];
					break;
