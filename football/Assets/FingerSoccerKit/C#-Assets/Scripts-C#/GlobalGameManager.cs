...
public class GlobalGameManager : MonoBehaviour {
	...
	public static string player1Name = "Íæ¼Ò1";
	public static string player2Name = "Íæ¼Ò2";
	public static string cpuName = "µçÄÔ";
	...
	*/
	...
	void manageGameStatus (){
		...
		timeText.GetComponent<TextMeshPro>().text = remainingTime.ToString();

		playerGoalsText.GetComponent<TextMeshPro>().text = playerGoals.ToString();
		opponentGoalsText.GetComponent<TextMeshPro>().text = opponentGoals.ToString();

		if(gameMode == 0) {
			playerOneName.GetComponent<TextMeshPro>().text = player1Name;
			playerTwoName.GetComponent<TextMeshPro>().text = cpuName;
		} else if(gameMode == 1) {
			playerOneName.GetComponent<TextMeshPro>().text = player1Name;
			playerTwoName.GetComponent<TextMeshPro>().text = player2Name;
		} 
	}
